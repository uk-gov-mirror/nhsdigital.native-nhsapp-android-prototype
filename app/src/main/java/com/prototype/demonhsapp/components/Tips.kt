    ...
    TooltipBox(
        ...
        tooltip = {
            RichTooltip(
                ...
                action = {
                    TextButton(onClick = { scope.launch { tooltipState.dismiss() } }, colors = ButtonDefaults.textButtonColors(contentColor = nhsBlue)) {
        ...
        //Content here
        FloatingActionButton(onClick = { scope.launch { tooltipState.show() }}, containerColor = Color.White) {
