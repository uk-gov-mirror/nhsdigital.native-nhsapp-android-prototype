...
fun PastPrescriptions(navController: NavController, modifier: Modifier) {
    ...
    Scaffold(
        ...
        topBar = {
            MediumTopAppBar(
                title = {
                    Text("Past prescriptions", maxLines = 1, overflow = TextOverflow.Ellipsis, fontSize = 32.sp, fontWeight = FontWeight.Normal)
                },
                navigationIcon = {
                        ...
                        Card(Modifier.padding(bottom = 16.dp), colors = CardDefaults.cardColors(Color.White)) {
                            Column () {
                                ListItem(
                                    ...
                                    headlineContent = { Text("Repeat prescription", modifier = Modifier.padding(top = 16.dp, bottom = 8.dp)) },
                                    leadingContent = { },
                                    overlineContent = {
