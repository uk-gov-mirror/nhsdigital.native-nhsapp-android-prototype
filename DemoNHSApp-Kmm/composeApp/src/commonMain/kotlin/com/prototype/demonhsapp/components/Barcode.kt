...
import demonhsappkmm.composeapp.generated.resources.barcode
import demonhsappkmm.composeapp.generated.resources.compose_multiplatform
import demonhsappkmm.composeapp.generated.resources.save_to_google_pay___english__dark_
                ...
                supportingContent = {
                    AnimatedVisibility(showBarcode) {
                        Column(horizontalAlignment = Alignment.CenterHorizontally) {
                            Image(painter = painterResource(Res.drawable.barcode), contentDescription = null, contentScale = ContentScale.Fit)
                            Text("ID: 1234 5678 9101", fontWeight = FontWeight.SemiBold)
                            Text("Only show this barcode if your pharmacist asks.")
                            Image(painterResource(Res.drawable.save_to_google_pay___english__dark_), contentDescription = null, contentScale = ContentScale.Fit)
                        }
                    }
                }
